...
psimage < dataobs_org_$g.binrg > gather_dataobs_org_$g.ps n1=$nto f1=0 d1=$dt f2=$f2km d2=$d2km legend=0 f2num=-1000 d1num=2 d2num=5 \
...
psimage < datar_$g.binrg > gather_datar_$g.ps n1=$nto f1=0 d1=$dt f2=$f2km d2=$d2km legend=0 d1num=2 f2num=-1000 d2num=5 \
...
translate=6,6 translate=4,6 translate=2,6 translate=0,6 \
